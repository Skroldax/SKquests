...
function SKquests:InitConfig()
        ...
        UIDropDownMenu_Initialize(langDropdown, function(self, level)
            for _, lang in ipairs(languages) do
                ...
                info.func = function()
                    ...
                    SafePrint("Language changed to " .. lang.text)
    ...
    showTitleCheck:GetFontString():SetText("Show quest title")
    ...
    showImageCheck:GetFontString():SetText("Show map image")
    ...
    autoMinCheck:GetFontString():SetText("Auto minimize in combat")
    ...
    questieCheck:GetFontString():SetText("Questie integration")
